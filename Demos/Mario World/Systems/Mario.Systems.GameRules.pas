...
uses
   ...
   P2D.Core.Types, P2D.Core.Entity, P2D.Core.System, P2D.Core.World, P2D.Core.Event, P2D.Core.Events,
...
begin
   ...
   begin
      ...
      if Assigned(FSM) then
         { FSM transition → TEnemySystem.OnGoombaEnterStomped handles visuals, freeze, and lifetime countdown. No direct DestroyEntity needed. }
