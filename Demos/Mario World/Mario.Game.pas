...
begin
   inherited Create(800, 600, 'P2DGE - Super Pascal World Demo', 60);
end;
...
begin
   ...
   FUnderwaterScene := TUnderwaterScene.Create(ScreenW, ScreenH);
   ...
   SceneManager.RegisterScene(FUnderwaterScene);
