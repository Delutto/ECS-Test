...
uses
	raylib, P2D.Core.Entity, P2D.Core.System, P2D.Core.World,
...
begin
  ...
  begin
    if not E.Alive then
		Continue;
    if not E.HasComponent(TTileMapComponent) then
		Continue;
    ...
    for R := 0 to TM.MapRows-1 do
	  ...
	  begin
        ...
        DrawTexturePro(TM.TileSet, Src, Dst, Vector2(0,0), 0, WHITE);
      end;
  end;
end;
end.