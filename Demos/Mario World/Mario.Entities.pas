...
begin
   ...
   { Screen-space anchor (Position.Y = top of the layer on the virtual canvas).
    Scale drives how many times larger than source pixels the texture is drawn. }
   ...
   { Parallax component holds the texture directly — no TSpriteComponent.
    This prevents TRenderSystem from matching this entity and drawing the
    full-resolution texture in rlWorld space at zoom-multiplied size. }
