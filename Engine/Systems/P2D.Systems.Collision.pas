...
uses
  SysUtils, Math,
  P2D.Common,
  P2D.Core.ComponentRegistry, P2D.Core.Types, P2D.Core.Entity, P2D.Core.System, P2D.Core.Events, P2D.Core.Event,
   ...
   begin
      ...
      begin
         ...
         case Tile.TileType of
            ...
            TILE_HAZARD: World.EventBus.Publish(TEntityHazardEvent.Create(ATr.OwnerEntity, C, Row)); { ④ Hazard tile: no geometric resolution — publish event only. }
         end;
