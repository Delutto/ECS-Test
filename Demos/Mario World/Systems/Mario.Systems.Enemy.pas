...
uses
  ...
  P2D.Components.StateMachine, P2D.Components.Lifetime,
  P2D.Utils.Math,
  Mario.Common, Mario.Components.Player, Mario.Components.Enemy;
...
begin
  ...
  begin
    ...
    if TGoombaState(FSM.CurrentState) = gsStomped then Continue;
